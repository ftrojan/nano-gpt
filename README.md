...
Run 6 hours and reported saving checkpoint to out-shakespeare-char
iter 2000: loss 1.2899

```
$ python sample.py --out_dir=out-shakespeare-char --device=cpu > ./out-shakespeare-char/output.txt
```
